...
export const dealer = {
  ...
  line: "ke030",
  email: "",
  location: "凱騰鈴木 Suzuki 北投所｜台北市北投區承德路七段143號",
  brandColor: "#e60012",
} as const;
...
export const cars: Car[] = [
  {
    ...
    price: "115 萬起",
    highlights: ["純電行駛", "續航 400km+", "ALLGRIP-e 四驅"],
    detail: {
      tagline: "純電新生活，即刻展開",
      specs: [
        "動力系統：純電馬達 (61kWh 電池)",
        "驅動方式：2WD / ALLGRIP-e 四驅",
        "續航里程：約 400km+ (WLTC)",
        "充電：DC 快充 150kW",
  ...
  },
  {
    ...
    price: "98 萬起",
    highlights: ["440L 行李廂", "48V 輕油電", "Level 2 輔助駕駛"],
    detail: {
      tagline: "跨界全能，唯我電能",
      specs: [
